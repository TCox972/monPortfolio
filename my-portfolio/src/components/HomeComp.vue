...
<template>
    <div class="home container-fluid h-100 py-5">
        <div class="row gy-5 gy-lg-0 my-lg-5 h-100 align-items-center justify-content-lg-center">
...
<style scoped>
.home{
    background-image: url("./icons/homeBg.jpg");
